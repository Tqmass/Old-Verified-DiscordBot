...
let user = message.mentions.users.first(); 
                  let member1 = message.mentions.users.first()
                    ...
                    const embed = new Discord.RichEmbed()
                        ...
                        .setAuthor("Jump. | Blur [Ejemplo]",  client.user.avatarURL)
                        .setDescription("<a:configurating:652935790846017537> __**Menciona a un/una Usuario/a**__")
                        .setImage("https://media.discordapp.net/attachments/595203556487725087/653190178604711936/file.jpg")
                        .setColor("RANDOM")
...
let img = await marsnpm.blur(member.displayAvatarURL)
