...
let escribir = args.join(' ');
 ...
 const embed = new Discord.RichEmbed()
                        ...
                        .setAuthor("Jump. | Eyes [Ejemplo]",  client.user.avatarURL)
                        .setDescription("<a:configurating:652935790846017537> | __**Escribe 3 textos**__ \n \n \n · ___Recuerda separar los textos con una coma___")
                        .setImage("https://images3.memedroid.com/images/UPLOADED315/5990d588eae14.jpeg")
                        .setColor("RANDOM")
...
let img = await weez.eyes(opt[0], opt[1], opt[2])
